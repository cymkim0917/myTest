...
public class MainPage extends JPanel{
	...
	public MainPage(JFrame mf) {
		...
		this.setBounds(0,0,978,730);
		this.setLayout(null);

		//배경
		JLabel background = new JLabel(new ImageIcon(new ImageIcon("ev-Image/mainPage/mainScreen.PNG").getImage().getScaledInstance(978, 730, 0)));
