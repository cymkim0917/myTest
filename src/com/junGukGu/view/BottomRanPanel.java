...
public class BottomRanPanel extends JPanel{
	...
	public BottomRanPanel(JFrame mf, JPanel bottomPanel) {
		...
		JLabel ranBottom = new JLabel(new ImageIcon(new ImageIcon("ev-Image/gamePage/bottomRanPanel.png").getImage().getScaledInstance(978, 120, 0)));
		ranBottom.setBounds(0, 0, 978, 120);	
