...
//		this.mf = mf;
		...
		helpPage.setBounds(0,0,978,730);
		helpPage.setLayout(null);
		//배경
		JLabel background = new JLabel(new ImageIcon(new ImageIcon("ev-Image/helpPage/helpScreen.PNG").getImage().getScaledInstance(978, 730, 0)));
		background.setBounds(0, 0, 978, 730);
		//나가기 버튼
