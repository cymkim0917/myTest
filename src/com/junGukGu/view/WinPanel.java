...
public class WinPanel extends JPanel {
		...
		public WinPanel(JFrame mf, JPanel gamePanel) {
			...
			JLabel winPanel2 = new JLabel(new ImageIcon(new ImageIcon("ev-Image/gamePage/winPanel.PNG").getImage().getScaledInstance(415, 300, 0)));
			winPanel2.setBounds(0, 0 ,415, 300);
			...
			JButton registration = new JButton("등 록");
			
			registration.setLocation(280, 227);
			registration.setSize(70, 25);
