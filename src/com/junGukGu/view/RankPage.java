...
public class RankPage extends JPanel{
	...
	public RankPage(JFrame mf) {
		...
		rankPage.setBounds(0,0,978,730);
		rankPage.setLayout(null);
		//배경
		JLabel background = new JLabel(new ImageIcon(new ImageIcon("ev-Image/rankPage/rankScreen.PNG").getImage().getScaledInstance(978, 730, 0)));
